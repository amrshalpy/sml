...
class ClubQrCode extends StatefulWidget {
  const ClubQrCode({Key? key}) : super(key: key);

  @override
  State<ClubQrCode> createState() => _ClubQrCodeState();
}

class _ClubQrCodeState extends State<ClubQrCode> {
