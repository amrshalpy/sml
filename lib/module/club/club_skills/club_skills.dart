...
class ClubSkills extends StatefulWidget {
  ClubSkills({Key? key, this.position}) : super(key: key);
  String? position;
  @override
  _ClubSkillsState createState() => _ClubSkillsState();
}

class _ClubSkillsState extends State<ClubSkills> {
