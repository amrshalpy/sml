                            ...
                            child: Container(
                              ...
                              child: ListView.separated(
                                itemBuilder: (context, index) => InkWell(
                                    onTap: () {
                                      cubit.changeCountr(
                                          cubit.countryModel!.data![index].id,
                                          cubit
                                              .countryModel!.data![index].name);
                                      print(cubit.city);
                                      // print('country');
                                      setState(() {
                                        isCountry = false;
                                ...
                                itemBuilder: (context, index) => InkWell(
                                    onTap: () {
                                      cubit.changecity(
                                        ...
                                        cubit.cityModel!.data![index].name,
                                      );
                                      print(cubit.city);
                                      // print('country');
                                      setState(() {
                                    ...
                                    child:
                                        getCity(cubit.cityModel!.data![index])),
                                separatorBuilder: (context, index) => SizedBox(
                                  height: 10,
                                  child: Divider(
                                    color: Colors.black,
                              ...
                              child: ListView.separated(
                                itemBuilder: (context, index) => InkWell(
                                    onTap: () {
                                      cubit.changeNation(
                                        cubit.countryModel!.data![index].id,
                                        cubit.countryModel!.data![index].name,
                                      );
                                      print(cubit.nation);
                                      // print('country');
                                      setState(() {
