class PerformancDataModel {
  String? message;
  Data? data;
  int? status;

  PerformancDataModel({this.message, this.data, this.status});

  PerformancDataModel.fromJson(Map<String, dynamic> json) {
...
class User {
 ...
 Performance? performance;
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    position = json['position']!=null?ExPosition.fromJson(json['position']):null;
...
class ExPosition {
  ...
  ExPosition({this.id, this.name, this.image});
